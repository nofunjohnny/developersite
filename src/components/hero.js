      ...
      <FrontPageHeader>
        ...
        <SocialIconWrapper>
          <SocialLink href="https://twitter.com/gabdorf">
            ...
            > <title id="twitterTitle">John Zapata's twitter profile</title><desc id="twitterDesc">John Zapata's twitter profile</desc>
              <path
          ...
          <SocialLink href="https://dribbble.com/gabdorf">
            <SocialIcon
              ...
              viewBox="0 0 24 24"
              xmlns="http://www.w3.org/2000/svg"
            > <title id="dribbbleTitle">John Zapata's dribbble profile</title><desc id="dribbbleDesc">John Zapata's dribbble profile</desc>
              <path
          ...
          <SocialLink href="mailto:gabriel.adorf@gmail.com">
            <SocialIcon
              ...
              viewBox="0 0 24 24"
              xmlns="http://www.w3.org/2000/svg"
            > <title id="mailTitle">Send email to John Zapata</title><desc id="mailDesc">Send email to John Zapata</desc>
              <path
